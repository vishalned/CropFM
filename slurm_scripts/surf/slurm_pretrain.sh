...
#SBATCH --output=/home/vnedungadi/CropFM/slurm_logs/pretrain_%j.out
#SBATCH --error=/home/vnedungadi/CropFM/slurm_logs/pretrain_%j.err
#SBATCH --ntasks=1
#SBATCH --mem=32G
...
SOURCE_ZARR_PATH=${CROPFM_DATA_DIR}/global_data_1200_merged_cleaned_rechunked.zarr
SOURCE_NORM_PATH=${CROPFM_DATA_DIR}/normalization_stats_global.json
...
python -u src/cropfm/models/main_pretrain.py \
    --config-name base.pretrain \
    hydra.run.dir=experiments/pretrain/base_pretrain_run_global \
