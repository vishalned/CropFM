...
#SBATCH --error=/home/vnedungadi/CropFM/slurm_logs/pretrain_%j.out
#SBATCH --ntasks=1
#SBATCH --mem=64G
...
SOURCE_ZARR_PATH=${CROPFM_DATA_DIR}/europe_data_1200_merged_cleaned2_rechunked.zarr
SOURCE_NORM_PATH=${CROPFM_DATA_DIR}/normalization_stats2.json
