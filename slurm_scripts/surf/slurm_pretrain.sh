...
#SBATCH --output=/home/vnedungadi/CropFM/slurm_logs/pretrain_contrastive_run_clean_global_%j.out
#SBATCH --error=/home/vnedungadi/CropFM/slurm_logs/pretrain_contrastive_run_clean_global_%j.err
#SBATCH --ntasks=1
#SBATCH --mem=32G
...
ZARR_FILE="global_data_1200_merged_cleaned_rechunked.zarr"

# Source zarr path (can be set via environment variable or use default)
SOURCE_ZARR_PATH=${CROPFM_DATA_DIR}/global_data_1200_merged_cleaned_rechunked.zarr # global is at /lustre/scratch/WUR/AIN/nedun001/CropFM/data/zarr_files/global_data_1200_merged_cleaned_rechunked.zarr
SOURCE_NORM_PATH=${CROPFM_DATA_DIR}/normalization_stats_global.json # global is at /lustre/scratch/WUR/AIN/nedun001/CropFM/data/zarr_files/normalization_stats_global.json
...
python -u src/cropfm/models/main_pretrain.py \
    ...
    hydra.run.dir=experiments/pretrain/contrastive_run_clean_global \
